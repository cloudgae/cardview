...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        models.add(new Model(R.drawable.tiramisu, "목적지", "어디로 여행을 갈지 골라보자"));
        models.add(new Model(R.drawable.mint, "숙소", "근처 숙소들을 찾아보고 숙소 가격을 알아보자"));
        models.add(new Model(R.drawable.cube, "장보기", "무엇을 사고 대충 비용이 얼마나 드는지 알아보자"));
